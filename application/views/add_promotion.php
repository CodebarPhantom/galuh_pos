...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo $lang_add_promotion; ?></h1>
		</div>
	</div><!--/.row-->
	
	<form action="<?=base_url()?>promotion/insertPromotion" method="post">
	<div class="row">
		<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="promotion_name" class="form-control"  maxlength="499" autofocus required autocomplete="off" />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label><?php echo $lang_discount; ?> </label>
								<input type="text" name="discount" class="form-control" maxlength="254" autocomplete="off" required />
							</div>
						</div>
						<div class="col-md-2">
							<div class="form-group">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" name="end_date" class="form-control" id="endDate" autocomplete="off" required />
							</div>
						</div>
					</div>
