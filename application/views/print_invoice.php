    ...
    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse;">
    	<tbody>
			...
			<tr>
				...
				<td style="text-align:right;font-weight:bold;">-<?php echo number_format($dis_amt); ?></td>
			</tr>
			<?php
			...
			<tr>
				...
				<td style="text-align:right;font-weight:bold;"><?php echo number_format($tax_amt); ?></td>
			</tr>
			<tr>
				...
				<td colspan="2" style="border-top:1px solid #000; padding-top:5px; text-align:right; font-weight:bold;"><?php echo number_format($grandTotal); ?></td>
    		</tr>
    		
			<tr>    
				<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;"><?php echo $lang_paid_amt; ?></td>
				<td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;"><?php echo number_format($paid_amt); ?></td>
    		</tr>
    		<?php
                if ($return_change > 0) {
                    ?>
    		<tr>
				...
				<td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;"><?php echo number_format($return_change); ?></td>
    		</tr>
    		<?php
		    ...
		    <tr>
				...
				<td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;"><?php echo number_format($unpaid_amt); ?></td>
    		</tr>
		    <?php
