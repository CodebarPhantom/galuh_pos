					...
					<div class="row">
						<div class="col-md-7">
							<div class="form-group">
								...
								if ($url_sales_id > 0) {
									$u_sales_id = $url_sales_id;
								} else {
									$u_sales_id = " ";
								}
								 ?>
								<textarea name="remark" class="form-control" style="height: 70px;"><?php echo "Refund for Sales ID ".$u_sales_id ?></textarea>
							</div>
						</div>
						<div class="col-md-5"></div>
					</div>
