...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo $lang_report_details; ?></h1>
		</div>
	</div><!--/.row-->
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form action="<?=base_url()?>reports/exportreport_details" method="post">
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label><?php echo $lang_start_date; ?></label>
								<input type="text" name="start_date" autocomplete="off" class="form-control" id="startDate" required value="<?php echo $url_start; ?>" />
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label><?php echo $lang_end_date; ?></label>
								<input type="text" name="end_date" autocomplete="off" class="form-control" id="endDate" required value="<?php echo $url_end; ?>" />
							</div>
                        </div>
                        <div class="col-md-3">
								<div class="form-group">
									...
									<?php
                                        $catData = $this->Reports_model->category_asc();
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="submit" class="btn btn-success" value="<?php echo $lang_export_to_excel; ?>" />
							</div>
						</div>
					</div>
					</form>
...
<table id="example" class="display" cellspacing="0" width="100%">
    <thead>
        <tr>
            ...
            <th width="12%"><?php echo $lang_promotion;?></th>
